...
public class RoutesSQLiteHelper extends SQLiteOpenHelper {
    ...
    public static final String TABLE_AGENCIES = "routes";
    ...
    private static final String DATABASE_CREATE =
        "CREATE TABLE " + TABLE_AGENCIES + " (" +
            ...
            "NOT NULL FOREIGN KEY(trackartist) REFERENCES artist(artistid)" + COLUMN_REGION_TITLE + " TEXT NOT NULL" +
        ");";

    public RoutesSQLiteHelper(Context context) {
