...
/**
 * Manages database creation and version management for a NextBus SQLite database.
 * Contains constants associated with table and column names.
 */
public class NextbusSQLiteHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLE_ROUTE_CONFIGURATIONS =
            "CREATE TABLE " + ROUTE_CONFIGURATIONS.TABLE + " (" +
                ...
                ROUTE_CONFIGURATIONS.COLUMN_ROUTE + " INTEGER NOT NULL UNIQUE REFERENCES " + ROUTES.TABLE + "(" + ROUTES.COLUMN_AUTO_ID + ") ON DELETE CASCADE, " +
    ...
    private static final String CREATE_TABLE_SERVICE_AREAS =
            "CREATE TABLE " + SERVICE_AREAS.TABLE + " (" +
                ...
                SERVICE_AREAS.COLUMN_ROUTE_CONFIGURATION + " INTEGER NOT NULL REFERENCES " + ROUTE_CONFIGURATIONS.TABLE + "(" + ROUTE_CONFIGURATIONS.COLUMN_AUTO_ID + ") ON DELETE CASCADE, " +
            ");";
    ...
    private static final String CREATE_TABLE_STOPS =
            "CREATE TABLE " + STOPS.TABLE + " (" +
                ...
                STOPS.COLUMN_AGENCY + " INTEGER NOT NULL REFERENCES " + AGENCIES.TABLE + "(" + AGENCIES.COLUMN_AUTO_ID + ") ON DELETE CASCADE, " +
    ...
    private static final String CREATE_TABLE_GEOLOCATIONS =
            "CREATE TABLE " + GEOLOCATIONS.TABLE + " (" +
                ...
                GEOLOCATIONS.COLUMN_STOP + " INTEGER NOT NULL REFERENCES " + STOPS.TABLE + "(" + STOPS.COLUMN_AUTO_ID + ") ON DELETE CASCADE" +
            ");";
    ...
    private static final String CREATE_TABLE_ROUTE_CONFIGURATIONS_STOPS =
            "CREATE TABLE " + ROUTE_CONFIGURATIONS_STOPS.TABLE + " (" +
                ...
                ROUTE_CONFIGURATIONS_STOPS.COLUMN_ROUTE_CONFIGURATION + " INTEGER NOT NULL REFERENCES " + ROUTE_CONFIGURATIONS.TABLE + "(" + ROUTE_CONFIGURATIONS.COLUMN_AUTO_ID + ") ON DELETE CASCADE, " +
                ROUTE_CONFIGURATIONS_STOPS.COLUMN_STOP + " INTEGER NOT NULL REFERENCES " + STOPS.TABLE + "(" + STOPS.COLUMN_AUTO_ID + ") ON DELETE CASCADE" +
            ");";
    ...
    private static final String CREATE_TABLE_DIRECTIONS =
            "CREATE TABLE " + DIRECTIONS.TABLE + " (" +
                ...
                DIRECTIONS.COLUMN_ROUTE + " INTEGER NOT NULL REFERENCES " + ROUTES.TABLE + "(" + ROUTES.COLUMN_AUTO_ID + ") ON DELETE CASCADE, " +
                DIRECTIONS.COLUMN_TAG + " TEXT NOT NULL, " +
                DIRECTIONS.COLUMN_TITLE + " TEXT NOT NULL, " +
                DIRECTIONS.COLUMN_NAME + " TEXT NOT NULL, " +
                DIRECTIONS.COLUMN_ROUTE_CONFIGURATION + " INTEGER NOT NULL REFERENCES " + ROUTE_CONFIGURATIONS.TABLE + "(" + ROUTE_CONFIGURATIONS.COLUMN_AUTO_ID + ") ON DELETE CASCADE" +
            ");";
    ...
    private static final String CREATE_TABLE_DIRECTIONS_STOPS =
            ...
            "FOREIGN KEY(" + DIRECTIONS_STOPS.COLUMN_DIRECTION + ") REFERENCES " + DIRECTIONS.TABLE + "(" + DIRECTIONS.COLUMN_AUTO_ID + ") ON DELETE CASCADE, " +
            "FOREIGN KEY(" + DIRECTIONS_STOPS.COLUMN_STOP + ") REFERENCES " + STOPS.TABLE + "(" + STOPS.COLUMN_AUTO_ID + ") ON DELETE CASCADE" +
            ");";
    ...
    private static final String CREATE_TABLE_PATHS =
            "CREATE TABLE " + PATHS.TABLE + " (" +
                ...
                PATHS.COLUMN_ROUTE + " INTEGER NOT NULL REFERENCES " + ROUTES.TABLE + "(" + ROUTES.COLUMN_AUTO_ID + ") ON DELETE CASCADE, " +
                PATHS.COLUMN_PATH_ID + " TEXT NOT NULL, " +
                PATHS.COLUMN_ROUTE_CONFIGURATION + " INTEGER NOT NULL REFERENCES " + ROUTE_CONFIGURATIONS.TABLE + "(" + ROUTE_CONFIGURATIONS.COLUMN_AUTO_ID + ") ON DELETE CASCADE" +
            ");";
    ...
    private static final String CREATE_TABLE_POINTS =
            "CREATE TABLE " + POINTS.TABLE + " (" +
                ...
                POINTS.COLUMN_PATH + " INTEGER NOT NULL REFERENCES " + PATHS.TABLE + "(" + PATHS.COLUMN_AUTO_ID + ") ON DELETE CASCADE" +
            ");";
    ...
    private static final String CREATE_TABLE_VEHICLE_LOCATIONS =
            "CREATE TABLE " + VEHICLE_LOCATIONS.TABLE + " (" +
                ...
                VEHICLE_LOCATIONS.COLUMN_ROUTE + " INTEGER NOT NULL REFERENCES " + ROUTES.TABLE + "(" + ROUTES.COLUMN_AUTO_ID + "), " +
